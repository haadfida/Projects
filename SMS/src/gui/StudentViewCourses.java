 ...
 * @author haadfida
 */
public class StudentViewCourses extends javax.swing.JFrame {
    /**
    ...
    public StudentViewCourses(LMS lms,String userid) {
        initComponents();
        setColor(btn_home);
           ...
           for (Sections s: SecList)
            {
                     ...
                     model.addRow(new Object[]{s.getCourse().getCourseID(),s.getCourse().getName(),s.getSection()});        
    ...
    private void initComponents() {
        ...
        jTableitem.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "CourseID", "Course Name", "SectionID"
            }
        ) {
  ...
  DefaultTableModel model= (DefaultTableModel)jTableitem.getModel();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(StudentViewCourses.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new StudentViewCourses(lms,userid).setVisible(true);
            }
        });
    }
