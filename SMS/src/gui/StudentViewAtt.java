 ...
 * @author haadfida
 */
public class StudentViewAtt extends javax.swing.JFrame {
    /**
    ...
    public StudentViewAtt(LMS lms,String userid) {
        initComponents();
        setColor(btn_home);
    ...
    private void initComponents() {
        ...
        btn_TakeAttendance.setLabel("View Attendance");
...
ArrayList <Student> StudentList= new ArrayList<>();
  ...
  jTextField1.setText(check);
    ...
    private void btn_TakeAttendanceActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_TakeAttendanceActionPerformed
     StudentViewAttCourse s =new StudentViewAttCourse(lms,userid,tosearch);
     s.setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(StudentViewAtt.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new StudentViewAtt(lms,userid).setVisible(true);
            }
        });
    }
