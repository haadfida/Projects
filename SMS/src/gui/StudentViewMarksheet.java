 ...
 * @author haadfida
 */
public class StudentViewMarksheet extends javax.swing.JFrame {
    /**
    ...
    int projectcount;
    int finalcount;
    public StudentViewMarksheet(LMS lms,Sections tosearch,String userid) {
        initComponents();
        setColor(btn_home);
...
// Append a row 
         ...
         ArrayList <Marksheet> MarkSheetList= tosearch.getMarksheetList();
         int rows=MarkSheetList.size();
         int i=0;
         int j=0;
         ...
         ArrayList <Student> StudentList=tosearch.getStudentList();
           if(StudentList!=null){
                for (Student s: StudentList)
            {
                     ...
                     model.addRow(new Object[]{s.getUserId()});        
...
//            {
//              
//               model.addRow(new Object[]{"hi","i","don't","know"});
//                 
//            }
                ...
                for (Marksheet m: MarkSheetList)
            {
                System.out.println(i);
                    ArrayList <Marks> MarksList= m.getMarksList();
                    int cols=MarksList.size();
                    for(j=0; j<cols; j++){
                    float disp=MarksList.get(j).getObtainedmarks();
                    
                   model.setValueAt(MarksList.get(j).getObtainedmarks(), i,j+1);
                    
                
                    
                    }
                    if(j==cols){
                         model.setValueAt(m.getGrade(), i,j+1);
                    }
    ...
    private void initComponents() {
        ...
        btn_homeLayout.setVerticalGroup(
            btn_homeLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addComponent(jPanel12, javax.swing.GroupLayout.DEFAULT_SIZE, 68, Short.MAX_VALUE)
            .addGroup(btn_homeLayout.createSequentialGroup()
...
//        sectionID=model.getValueAt(selectedrow,4).toString();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(StudentViewMarksheet.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new StudentViewMarksheet(lms,tosearch,userid).setVisible(true);
            }
        });
    }
