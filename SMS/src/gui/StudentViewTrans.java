 ...
 * @author haadfida
 */
public class StudentViewTrans extends javax.swing.JFrame {
    /**
    ...
    int projectcount;
    int finalcount;
    public StudentViewTrans(LMS lms,String userid) {
        initComponents();
        setColor(btn_home);
        ...
        this.lms=lms;
        this.userid=userid;
       ArrayList <semester> SemList=lms.SearchStudentsSems(userid);
       DefaultTableModel model = (DefaultTableModel)jTableitem.getModel();
       ArrayList <semdata> SemDataList=lms.getSemDataList(userid);
       
       
       float disp=0;
           for (semdata s: SemDataList)
            {
                int getid=s.getSemID();
                if(getid==1){
                if(SemList.get(0)!=null){
                semester temp=SemList.get(0);
                disp=temp.getSgpa();
                }
                }
                else if(getid==2){
                if(SemList.get(1)!=null){
                semester temp=SemList.get(1);
                disp=temp.getSgpa();
                }
                }
                 else if(getid==3){
                if(SemList.get(2)!=null){
                semester temp=SemList.get(2);
                disp=temp.getSgpa();
                }
                }
                 else if(getid==4){
                if(SemList.get(3)!=null){
                semester temp=SemList.get(3);
                disp=temp.getSgpa();
                }
                }
                 else if(getid==5){
                if(SemList.get(4)!=null){
                semester temp=SemList.get(4);
                disp=temp.getSgpa();
                }
                }
                  else if(getid==6){
                if(SemList.get(5)!=null){
                semester temp=SemList.get(5);
                disp=temp.getSgpa();
                }
                }
                  else if(getid==7){
                if(SemList.get(6)!=null){
                semester temp=SemList.get(6);
                disp=temp.getSgpa();
                }
                }
                 else if(getid==8){
                if(SemList.get(7)!=null){
                semester temp=SemList.get(7);
                disp=temp.getSgpa();
                }
                }
                model.addRow(new Object[]{s.getSemID(),s.getCourseName(),s.getGrade(),disp});    
           ...
           for(int i=0; i< rows; i++){
                   ...
                   val+= Float.parseFloat(model.getValueAt(i,3).toString());
                    
                   }
            // jTextField1.setText(model.getValueAt(selectedrow,0).toString()+" "+model.getValueAt(selectedrow,4).toString());  
           val=val/rows;
         jTextField1.setText(Float.toString(val)); 
    }
    ...
    private void initComponents() {
        ...
        side_panel.add(button_exit, new org.netbeans.lib.awtextra.AbsoluteConstraints(100, 30, 55, -1));
        ...
        jTableitem.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "semesterID", "Course Name", "Grade", "SGPA"
            }
        ) {
...
//        sectionID=model.getValueAt(selectedrow,4).toString();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(StudentViewTrans.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new StudentViewTrans(lms,userid).setVisible(true);
            }
        });
    }
