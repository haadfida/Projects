 ...
 * @author haadfida
 */
public class TeacherTakeAttd extends javax.swing.JFrame {
    /**
    ...
    public TeacherTakeAttd(LMS lms,Sections tosearch,String userid) {
        initComponents();
        setColor(btn_home);
        ...
        this.lms=lms;
        this.userid=userid;
       StudentList2=tosearch.getStudentList();
    ...
    private void initComponents() {
        ...
        side_panel.add(button_exit, new org.netbeans.lib.awtextra.AbsoluteConstraints(100, 10, 55, -1));
        ...
        btn_TakeAttendance.setLabel("Save");
...
String toadd="A";
  ...
  DefaultTableModel model= (DefaultTableModel)jTableitem.getModel();
   ...
   tosearch.addAttendance(a);
   String userid=model.getValueAt(i,0).toString();
   a.setAttendance(toadd,userid);
   }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TeacherTakeAttd.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TeacherTakeAttd(lms,tosearch,userid).setVisible(true);
            }
        });
    }
