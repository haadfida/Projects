 ...
 * @author haadfida
 */
public class SearchItemAuthor extends javax.swing.JFrame {
    /**
    ...
    public SearchItemAuthor(Library lms,String tosearch,String userid) {
        initComponents();
        setColor(btn_home);
        System.out.println(tosearch);
         ArrayList <Items> ItemList=lms.searchItembyAuthor(tosearch);
    ...
    private void initComponents() {
        ...
        jLabel12.setText("Search by Author");
...
int selected;
    ...
    private void jTextItemIDActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jTextItemIDActionPerformed
        ...
        ArrayList <Items> ItemList=lms.searchItembyAuthor(search);
        DefaultTableModel model= (DefaultTableModel)jTableitem.getModel();
        model.setRowCount(0);
        if(ItemList!=null){
        if(itemselect==1){
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SearchItemAuthor.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new SearchItemAuthor(lms,tosearch,userid).setVisible(true);
            }
        });
    }
