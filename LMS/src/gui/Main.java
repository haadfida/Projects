...
public class Main extends javax.swing.JFrame {
    ...
    public static Library lms=new library.Library();
    /**
    ...
    public void selectUser(){
        String sql = "SELECT id,age,username, password, address, email, telephone,fine,usertype FROM users";
        ...
        try {
            conn=DriverManager.getConnection(conn_string,username,password);
             ...
             String id,username,password,address,email;
             id=username=password=address=email=null;
             int age,usertype;
             double telephone;
             long fine;
            ...
            while (rs.next()) {
                                   ...
                                   if(usertype==1){
                                       Borrower b=new Borrower(id,age,username,password, address,email,telephone,fine);
                                       lms.loadBorrowers(b);
                                   }
                                    else if(usertype==2){
                                    Clerk c=new Clerk(id,age,username,password, address,email,telephone,fine);
                                       lms.loadClerk(c);
                                   
                                   }
                                    else if(usertype==3){
                                    Librarian l=new Librarian(id,age,username,password, address,email,telephone,fine);
                                    lms.loadLibrarian(l);
                                    }
    ...
    public void selectItems(){
        String sql = "SELECT id,title,author,genre,itemtype FROM Items";
        ...
        try {
            ...
            while (rs.next()) {
                                   ...
                                   if(itemtype==1){
                                    ...
                                    CDs c=new CDs(id,title,author,genre);
                                    lms.loadCDs(c);
    ...
    public void selectReservations(){
        ...
        String sql = "SELECT itemid,userid,resdate FROM Reservation";
        ...
        try {
            ...
            while (rs.next()) {
                                   ...
                                   Items i=lms.getItembyID(itemid);
                                   Users u=lms.getUserbyID(userid);
                                    Reservation r=new Reservation(i,u,resdate);
                                   lms.loadReservations(r,u);
      ...
      public void selectLoans(){
        ...
        String sql = "SELECT itemid,userid,issueDate,retDate FROM Loan";
        ...
        try {
            ...
            while (rs.next()) {
                                   ...
                                   retDate=rs.getDate("retDate");
                                   Items i=lms.getItembyID(itemid);
                                   Users u=lms.getUserbyID(userid);
                                    
                                   Loan l=new Loan(u,i);
                                   l.setIssueDate(issueDate);
                                   l.setReturnDate(retDate);
                                   lms.loadLoans(l,u,i);
       ...
       public void selectLoanHistory(){
    
        String sql = "SELECT itemid,userid,issueDate,retDate FROM LoanHistory";
    ...
    private void initComponents() {
        ...
        ComboUser2 = new javax.swing.JComboBox<>();
        ...
        ComboUser2.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "title", "author", "subject" }));
        ComboUser2.setToolTipText("");
        ComboUser2.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                ComboUser2ActionPerformed(evt);
            }
        });

        jLabel13.setIcon(new javax.swing.ImageIcon(getClass().getResource("/LBMS/images/research.png"))); // NOI18N
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel2Layout.createSequentialGroup()
                        ...
                        .addGap(174, 174, 174))
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel2Layout.createSequentialGroup()
                        .addComponent(ComboUser2, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(18, 18, 18)))
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
        ...
        ComboUser.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Borrower", "Clerk", "Librarian" }));
                ...
                .addGroup(jPanel7Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel7Layout.createSequentialGroup()
                        .addGroup(jPanel7Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                            ...
                            .addComponent(ComboUser, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                        .addGap(86, 305, Short.MAX_VALUE)
...
//       } 
    ...
    private void ComboUserActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ComboUserActionPerformed
        // TODO add your handling code here:
          ...
          if(ComboUser.getSelectedItem().equals("Borrower")){
         // JOptionPane.showMessageDialog(null,"Borrower Selected");
         selected=1;
          }
          else if(ComboUser.getSelectedItem().equals("Clerk"))
          {
          selected=2;
          }
          else if(ComboUser.getSelectedItem().equals("Librarian"))
          {
          selected=3;
          }
    }//GEN-LAST:event_ComboUserActionPerformed

    private void ComboUser2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ComboUser2ActionPerformed
        // TODO add your handling code here:
        //        "Borrower", "Clerk", "Librarian"
    ...
    }//GEN-LAST:event_ComboUser2ActionPerformed
    ...
    public static void main(String args[]) {
        ...
        //</editor-fold>
                ...
                app.selectUser();
                app.selectItems();
                app.selectReservations();
                app.selectLoans();
                app.selectLoanHistory();
...
//        }
    ...
    private javax.swing.JComboBox<String> ComboUser2;
