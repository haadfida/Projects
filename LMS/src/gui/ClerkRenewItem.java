 ...
 * @author haadfida
 */
public class ClerkRenewItem extends javax.swing.JFrame {
    ...
    public ClerkRenewItem(Library lms,String display,String userid) {
        initComponents();
        setColor(btn_home);
    ...
    private void initComponents() {
        ...
        jPanel6.add(jItemID, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 120, 352, -1));
        jPanel6.add(jUserID, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 230, 352, -1));

        btn_Renew.setActionCommand("d");
        btn_Renew.setBackground(new java.awt.Color(70, 120, 197));
        btn_Renew.setFont(new java.awt.Font("Lucida Grande", 0, 18)); // NOI18N
        btn_Renew.setForeground(new java.awt.Color(255, 255, 255));
        btn_Renew.setLabel("Renew");
        btn_Renew.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btn_RenewActionPerformed(evt);
            }
        });
        jPanel6.add(btn_Renew, new org.netbeans.lib.awtextra.AbsoluteConstraints(150, 330, 180, 40));

        getContentPane().add(jPanel6, new org.netbeans.lib.awtextra.AbsoluteConstraints(530, 80, 710, 670));
...
int xx,xy;
    ...
    private void btn_RenewActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_RenewActionPerformed
        ...
        boolean status= lms.RenewLoan(UserId, ItemId);
        if(status){
         JOptionPane.showMessageDialog(null,"Deadline Extended");
        }
        else
        {
...
int selected;
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ClerkRenewItem.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ClerkRenewItem(lms,userdisp,userid).setVisible(true);
            }
        });
    }
...
//        }
    ...
    private java.awt.Button btn_Renew;
