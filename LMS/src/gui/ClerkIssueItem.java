 ...
 * @author haadfida
 */
public class ClerkIssueItem extends javax.swing.JFrame {
    ...
    public ClerkIssueItem(Library lms,String display,String userid) {
        initComponents();
        setColor(btn_home);
        ...
        this.userid=userid;
         ...
         ArrayList <Reservation> ReservationList=lms.getItemReservations("");
         ...
         if(ReservationList!=null){
                for (Reservation x: ReservationList)
            {
                     ...
                     model.addRow(new Object[]{x.getItem().getItemId(),x.getUser().getUserId(),x.getUser().getUserName(),x.getDate()});        
    ...
    private void initComponents() {
        ...
        getContentPane().add(jPanel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 80, 360, 320));
        ...
        jPanel6.add(jUserID, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 70, 352, 30));
        ...
        jPanel6.add(jItemID, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 176, 352, 30));

        getContentPane().add(jPanel6, new org.netbeans.lib.awtextra.AbsoluteConstraints(530, 80, 710, 320));
        ...
        getContentPane().add(jScrollPane5, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 403, 1070, 350));

        jPanel1.setBackground(new java.awt.Color(255, 255, 255));

        btn_Issue.setActionCommand("d");
        btn_Issue.setBackground(new java.awt.Color(70, 120, 197));
        btn_Issue.setFont(new java.awt.Font("Lucida Grande", 0, 14)); // NOI18N
        btn_Issue.setForeground(new java.awt.Color(255, 255, 255));
        btn_Issue.setLabel("Issue");
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                .addGap(217, 217, 217)
                .addComponent(btn_Issue, javax.swing.GroupLayout.PREFERRED_SIZE, 140, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        getContentPane().add(jPanel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(530, 750, 710, -1));
        ...
        getContentPane().add(jPanel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 750, 360, -1));
...
int xx,xy;
    ...
    String UserId= jUserID.getText();
        ...
        Users u=lms.getUserbyID(UserId);
            ...
            Loan lobject=lms.LoanItemToUser(i, u);
...
jUserID.setText(model.getValueAt(selectedrow,1).toString());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ClerkIssueItem.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ClerkIssueItem(lms,userdisp,userid).setVisible(true);
            }
        });
    }
...
//        }
    ...
    private java.awt.Button btn_Issue;
