 ...
 * @author haadfida
 */
public class SearchItemTitle extends javax.swing.JFrame {
    ...
    public SearchItemTitle(Library lms,String tosearch,String userid) {
        initComponents();
        setColor(btn_home);
        this.lms=lms;
        ...
        this.userid=userid;
         ...
         ArrayList <Items> ItemList=lms.searchItemByTitle(tosearch);
    ...
    private void initComponents() {
        ...
        jLabel12.setText("Search by Title");
                ...
                .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel4Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addComponent(btn_Reserve, javax.swing.GroupLayout.DEFAULT_SIZE, 362, Short.MAX_VALUE)
...
int selected;
    ...
    private void jTextItemIDActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jTextItemIDActionPerformed
        ...
        ArrayList <Items> ItemList=lms.searchItemByTitle(search);
         DefaultTableModel model= (DefaultTableModel)jTableitem.getModel();
         model.setRowCount(0);
         if(ItemList!=null){
        if(itemselect==1){
...
int itemselect;
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SearchItemTitle.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new SearchItemTitle(lms,tosearch,userid).setVisible(true);
            }
        });
    }
