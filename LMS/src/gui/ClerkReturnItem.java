...
public class ClerkReturnItem extends javax.swing.JFrame {
    ...
    public ClerkReturnItem(Library lms, String display,String userid) {
        initComponents();
        setColor(btn_home);
    ...
    private void initComponents() {
        ...
        btn_Return.setActionCommand("d");
        btn_Return.setBackground(new java.awt.Color(70, 120, 197));
        btn_Return.setFont(new java.awt.Font("Lucida Grande", 0, 36)); // NOI18N
        btn_Return.setForeground(new java.awt.Color(255, 255, 255));
        btn_Return.setLabel("Return");
        btn_Return.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btn_ReturnActionPerformed(evt);
            }
        });
        jPanel6.add(btn_Return, new org.netbeans.lib.awtextra.AbsoluteConstraints(140, 335, 210, -1));
...
int xx,xy;
    ...
    private void btn_ReturnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_ReturnActionPerformed
        ...
        Users u=lms.getUserbyID(UserId);
            ...
            boolean status=lms.ReturnItem(u, i);
            ...
            {
                JOptionPane.showMessageDialog(null,"This item is not loaned to anyone");  
            }
...
int selected;
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ClerkReturnItem.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ClerkReturnItem(lms,userdisp,userid).setVisible(true);
            }
        });
    }
